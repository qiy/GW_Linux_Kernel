...
#define ATOM                            0XAA
#define ATOM_WRITE_INT                   _IOW(ALSPS, 0x10, int) 
#define ATOM_WRITE_OFF                   _IOW(ALSPS, 0x11, int) 
#define ATOM_WRITE_ON                    _IOW(ALSPS, 0x12, int)
...
//
static void _atom_en_pin_output_low(void)
{
	printk("[max--%s@%d]: flash en pin low  \n",__func__,__LINE__);
	pinctrl_select_state(_atom_ctrl, _atom_en_l);
}

static void _atom_en_pin_output_high(void)
{
