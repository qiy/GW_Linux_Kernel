...
/**********************************************************
  ...
  *
  *********************************************************/
#define bq24296_SLAVE_ADDR_WRITE   0xD4
#define bq24296_SLAVE_ADDR_READ    0xD5
...
/**********************************************************
  ...
  *
  *********************************************************/
kal_uint8 bq24296_reg[bq24296_REG_NUM] = {2};
...
{
	kal_uint8 reg_value1,reg_value2,reg_value3,reg_value4,reg_value5,reg_value6;	
	//pull CE low
...
*/
	bq24296_write_byte(0x06,0x7c); 
	bq24296_write_byte(0x00,0xc0);  /*4.35v*/
	bq24296_write_byte(0x02,0xbe);  /*0x8c:4.2;0xaa:4.35v*/
	bq24296_write_byte(0x04,0x11); //1.4A
	bq24296_write_byte(0x05,0x04);
	bq24296_write_byte(0x01,0xf0);	

	bq24296_read_byte(0x06,&reg_value1);	
	bq24296_read_byte(0x00,&reg_value2);  /*4.35v*/
	bq24296_read_byte(0x02,&reg_value3);  /*0x8c:4.2;0xaa:4.35v*/
	bq24296_read_byte(0x04,&reg_value4); //1.4A
	bq24296_read_byte(0x05,&reg_value5);
	bq24296_read_byte(0x01,&reg_value6);	
}
